...
$("#submit_btn").click(function() {
   ...
   if ($("#typewriting").length) {
      ...
      typewriter.typeString('NFT Hybrid Web3').pauseFor(2000).deleteAll()
         .typeString('Zero Advertising').pauseFor(2000).deleteAll()
         .typeString('Zero Gatekeeping').pauseFor(2000).deleteAll()
         .typeString('Full Transparency').start();
   }
